...
async function resourcePath(params: PageProps["params"]) {
  ...
  return "/docs/" + slug.map(decodeURIComponent).join("/");
}
...
export default async function Page({ params }: PageProps) {
  return <ResourceDetailPage path={await resourcePath(params)} backHref="/docs" backLabel="返回文档" kicker="Documentation" />;
}
